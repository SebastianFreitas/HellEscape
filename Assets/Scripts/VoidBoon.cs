...
internal class VoidBoon
{
    ...
    private void GetBoons()
    {
        ...
        //SPEED----------------------------------------------------------------
        BoonList.Add((5,     "Gain 20% more movement speed and shot speed",  BoonName.Speed));
        BoonList.Add((1,     "Ricochets get increasingly stronger",          BoonName.RicochectStack));
        BoonList.Add((1,     "Gain 100% shot speed",                         BoonName.ShootSpeed));
        //FIRE----------------------------------------------------------------
        ...
        BoonList.Add((2,      "Gain 25% of poison damage as fire damage", BoonName.ExtraPoisonToFire));
        BoonList.Add((2,      "Your dash and double jump are stronger", BoonName.StrongerDash));
        ...
        BoonList.Add((10, "Poison lasts 5 more seconds", BoonName.PoisonDuration));
        BoonList.Add((1,      "Ricochets bounce into close poisoned enemies", BoonName.PoisonFollow));
        BoonList.Add((5,      "Poisoned enemies deal 25% less damage", BoonName.WeakerPoison));
        BoonList.Add((2,      "Chilled enemies take 30% more poison damage", BoonName.PoisonedCold));
        BoonList.Add((2,      "Enemies who die from your poison have +5% chance of dropping healing packs", BoonName.VampiricPoison));
        ...
        //COLD------------------------------------------------------------------
        BoonList.Add((10, "+1% Chance your cold damage freezes the enemy", BoonName.ChanceFreeze1));
        BoonList.Add((2, "+2% Chance your cold damage freezes the enemy", BoonName.ChanceFreeze2));
        BoonList.Add((2,      "Freeze condition lasts one second longer", BoonName.LongerFreeze));
        BoonList.Add((5,      "Physical damage is converted to cold on critical hits.", BoonName.PhyisToColdCrit));
        BoonList.Add((2,      "Deal 50% more damage agaisnt frozen targets", BoonName.FrozenDamage));
        BoonList.Add((2,      "Enemies killed while chilled or frozen drop more gunparts", BoonName.MoreFrozenGunparts));
        BoonList.Add((3,      "Shoot an additional cold projectile", BoonName.AddedColdProjectile));
        ...
        BoonList.Add((2,      "Poisoned enemies are more affected by chill", BoonName.PoisonedChill));
        //PHYSICAL------------------------------------------------------------------
        BoonList.Add((10,      "Gain +10 physical damage", BoonName.MorePhys10));
        BoonList.Add((5,      "Gain +25 physical damage", BoonName.MorePhys25));
        ...
        BoonList.Add((5,      "Convert 50% of fire damage into physical damage", BoonName.FireToPhys50));
        BoonList.Add((3,      "Convert 100% of fire damage into physical damage", BoonName.FireToPhys100));
        BoonList.Add((3,      "50% reduced bullet speed \n Gain + 50 physical damage", BoonName.ReducedSpeedMorePhys));
